            ...
            return false;
        		...
        		if((entityliving.getCustomNameTag()!=p_111207_1_.getDisplayName())||(entityliving.getCustomNameTag()=="")){
        			...
        			if(p_111207_3_.isRiding() == false){
        				...
        				EntityMinecartEmpty entityMinecartEmpty = new EntityMinecartEmpty(p_111207_3_.worldObj,p_111207_3_.prevPosX, p_111207_3_.prevPosY, p_111207_3_.prevPosZ);
        				
                        NBTTagCompound nbttagcompound1 = new NBTTagCompound();
                        
                        if (entityMinecartEmpty.writeMountToNBT(nbttagcompound1))
                        {
                        	nbtTagCompound.setTag("Riding", nbttagcompound1);
                        }
                        
                        p_111207_3_.readFromNBT(nbttagcompound1);//
